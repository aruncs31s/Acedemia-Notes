...
Where: Q(\cdot) is the Q-function (tail probability of standard normal), $E_b$ energy per bit, $N_0/2$ one-sided noise PSD. Alternate form: $P_b = \frac{1}{2}\text{erfc}\big(\sqrt{E_b/N_0}\big)$.
